...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private ArrayList<Long> nodesInAWay = new ArrayList<>();
...
//            System.out.println("Node lat: " + attributes.getValue("lat"));
            ...
            long nodeToBeAdd = Long.parseLong(attributes.getValue("ref"));
            nodesInAWay.add(nodeToBeAdd);
            ...
            if (nodeName != "") {
                g.nodes.get(idMayHaveName).setName(nodeName);
            }
        }
    }
...
//            System.out.println("Finishing a way...");
            if(validWay) {
                while(nodesInAWay.size() >= 2) {
                    long first = nodesInAWay.get(0);
                    nodesInAWay.remove(0);
                    long second = nodesInAWay.get(0);
