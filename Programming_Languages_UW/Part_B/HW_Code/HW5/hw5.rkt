...
;; Enviroment is a Racket list of Racket pairs
         ...
         (let ([clo (eval-under-env (call-funexp e) env)])
           (if (closure? clo)
               (let* ([func (closure-fun clo)]
                      [envir (closure-env clo)]
                      [new-env-temp (let ([name (fun-nameopt func)])
                                      (if name
                                          (cons (cons name clo) envir)
                                          envir))]
                      [new-env (cons (cons (fun-formal func)
